...
const plans = [
    {
        ...
        features: [
            'Acceso a cursos básicos de Jabonería y Velas',
            'Blog y artículos exclusivos',
            'Videos en alta calidad (YouTube)',
            'Actualizaciones de contenido',
            'Soporte por email con Orquídea',
        ],
        notIncluded: ['Cursos avanzados', 'Clase personal mensual'],
        url: MP_BRONCE,
        popular: false,
    },
    {
        ...
        features: [
            'Todo lo de Cobre',
            'Cursos avanzados de Jabonería y Velas',
    ...
    },
    {
        ...
        features: [
            ...
            'Soporte 24/7 directo con Orquídea',
        ],
        notIncluded: [],
        url: MP_ORO,
        popular: false,
